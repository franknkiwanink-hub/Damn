...
//     forever
//
// NOT included, deliberately out of scope for this step: the original's
// __dismissBootOverlay also kicks off the "Welcome Back" full-screen
// takeover for returning users (window.__welcomeBackPending /
// __openWelcomeBack) once the boot overlay itself finishes. That's a
// separate, still-unbuilt feature (see README's "What's NOT done yet") —
// this component only owns the boot splash itself, not what happens
// right after it.
