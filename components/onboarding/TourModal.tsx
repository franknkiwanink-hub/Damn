...
// The theme picker itself is a large separate feature already tracked as
// a placeholder in AppearancePanel (its own "Open Theme Picker" button
// already toasts "isn't built yet"), so onFinish here is left to the
// parent to wire to that same not-built-yet placeholder rather than this
// component reaching into a feature it doesn't own.
